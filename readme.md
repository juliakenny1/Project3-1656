...
### Description
This is the **third assignment** for the CS 1656 -- Introduction to Data Science (CS 2056) class, for the Spring 2022 semester.
...
> **Output Format:** The output data should resemble a CSV file, where every row is in one of the following formats:  
...
For this test assignment you only need to submit `armin.py` to "Assignment #3" and see if you get all 100 points. In case of an error or wrong result, you can modify the file and resubmit it as many times as you want until the deadline of **Wednesday, March 23, 11:59 pm**.

### Late submissions

For full points, we will consider the version submitted to Gradescope 

* the day of the deadline **Monday, Mar 23, 11:59 pm**  
